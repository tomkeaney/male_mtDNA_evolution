...
male_zi_model <- glmmTMB(test ~ Focal_haplotype * Social_haplotype + Social_haplotype * Social_survival + factor(Duplicate) + (1|Block) + (1|Individual), data = Male_fitness_without_Brownsville, family = binomial, ziformula = ~1, na.action = na.fail, REML = FALSE)
