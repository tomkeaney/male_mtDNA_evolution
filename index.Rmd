...
**Survived ~ Focal_haplotype * Social_haplotype * Sex + Duplicate + (1|Block) + (1|Dyad_environment)**
...
**Figure 2:** Egg-to-adult development time is affected by an individual's mtDNA haplotype. The coloured points show the development time for individual flies. The black points show the median development time for males and females and its 95% confidence limits.
...
```{r male figure, fig.width= 9, fig.height= 4}
